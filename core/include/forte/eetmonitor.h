...
class CEETMonitor {
  public:
    ...
    void
    startPeriodicExport(const std::string &paDirectory, std::chrono::seconds paInterval, size_t paTargetSamples = 0);
    ...
    enum class ExecutionPhase { WARMUP, TRANSITION, FET_ACTIVE };
